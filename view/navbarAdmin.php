...
<head>
  ...
  <link rel="stylesheet" href="css/navbarAcceuil.min.css">
  <link rel="stylesheet" href="css/navbarClient.min.css">
  <link rel="stylesheet" href="css/navbarAssistant.min.css">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-right">
              ...
              <li class="dropdown-submenu dropleft">
                <a class="test dropdown-item" tabindex="-1" href="#"><i class="fa fa-arrow-circle-o-left pr-2" aria-hidden="true"></i>Gestion des comptes<span class="caret"></span></a>

                <ul class="dropdown-menu " id="submenu">
                  <li><a class="dropdown-item" tabindex="-1" href="gestionassistant.php"><i class="fa fa-paper-plane pr-2" aria-hidden="true"></i></i>Assistant</a></li>
                  <li><a class="dropdown-item" tabindex="-1" href="gestioncli.php"><i class="fa fa-users pr-2" aria-hidden="true"></i>Client</a></li>
                </ul>
